...
public class RenderBullet extends EntityRenderer<EntityBullet> {
    ...
    public RenderBullet(EntityRendererProvider.Context manager) {
    ...
    public void render(EntityBullet entityIn, float entityYaw, float partialTicks, PoseStack poseStackIn, MultiBufferSource bufferIn, int packedLightIn) {
