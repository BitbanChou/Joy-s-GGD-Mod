...
public class RenderPele extends EntityRenderer<EntityPele> {
    ...
    public RenderPele(EntityRendererManager manager) {
    ...
    public void render(EntityPele entityIn, float entityYaw, float partialTicks, MatrixStack poseStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
