...
public class Stove3Block extends ContainerBlock
{
    ...
    public Stove3Block(boolean p_i241174_1_, int p_i241174_2_, Properties p_i241174_3_) {
        super(p_i241174_3_);
    ...
    public ActionResultType use(BlockState state, World level, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult p_225533_6_) {
        ...
        if (tileentity instanceof Stove3BlockEntity) {
            Stove3BlockEntity et = (Stove3BlockEntity)tileentity;
...
//            TileEntity tileentity = p_196243_2_.getStove3BlockEntity(p_196243_3_);
...
//    }
    ...
    public void onRemove(BlockState state, World level, BlockPos pos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            TileEntity tileEntity = level.getBlockEntity(pos);
            if (tileEntity instanceof Stove3BlockEntity) {
                //ItemUtils.dropItems(level, pos, ((StoveStove3BlockEntity) tileEntity).inventory);
                InventoryHelper.dropContents(level, pos, ((Stove3BlockEntity)tileEntity).getItems());
            }
...
//        }
//
//        TileEntity tileentity = p_235475_0_.getStove3BlockEntity(p_235475_1_);
//        if (tileentity instanceof CampfireTileEntity) {
...
//    }
    ...
    public TileEntity newStove3BlockEntity(IBlockReader p_196283_1_) {
        return new Stove3BlockEntity();
    }
...
//    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
        list.add(new TranslationTextComponent("tooltip.gashapon3").withStyle(TextFormatting.GRAY));
