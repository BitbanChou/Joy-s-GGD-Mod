...
public class Stove2Block extends ContainerBlock
{
    ...
    public Stove2Block(boolean p_i241174_1_, int p_i241174_2_, Properties p_i241174_3_) {
        super(p_i241174_3_);
    ...
    public ActionResultType use(BlockState state, World level, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult p_225533_6_) {
        ...
        if (tileentity instanceof Stove2BlockEntity) {
            Stove2BlockEntity et = (Stove2BlockEntity)tileentity;
...
//            TileEntity tileentity = p_196243_2_.getStove2BlockEntity(p_196243_3_);
...
//    }
    ...
    public void onRemove(BlockState state, World level, BlockPos pos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            TileEntity tileEntity = level.getBlockEntity(pos);
            if (tileEntity instanceof Stove2BlockEntity) {
                //ItemUtils.dropItems(level, pos, ((StoveStove2BlockEntity) tileEntity).inventory);
                InventoryHelper.dropContents(level, pos, ((Stove2BlockEntity)tileEntity).getItems());
            }
...
//        }
//
//        TileEntity tileentity = p_235475_0_.getStove2BlockEntity(p_235475_1_);
//        if (tileentity instanceof CampfireTileEntity) {
...
//    }
    ...
    public TileEntity newStove2BlockEntity(IBlockReader p_196283_1_) {
        return new Stove2BlockEntity();
    }
...
//    }
    ...
    public void appendHoverText(ItemStack stack, @Nullable IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
        list.add(new TranslationTextComponent("tooltip.gashapon2").withStyle(TextFormatting.GRAY));
