...
public class Stove2Renderer extends TileEntityRenderer<Stove2BlockEntity> {
	public Stove2Renderer(TileEntityRendererDispatcher context) {
		super(context);
	}

	@Override
	public void render(Stove2BlockEntity stoveEntity, float partialTicks, MatrixStack poseStack, IRenderTypeBuffer buffer, int combinedLightIn, int combinedOverlayIn) {
		Direction direction = stoveEntity.getBlockState().getValue(Stove2Block.FACING).getOpposite();
