...
public class StoveRenderer extends TileEntityRenderer<StoveBlockEntity> {
	public StoveRenderer(TileEntityRendererDispatcher context) {
		super(context);
	}

	@Override
	public void render(StoveBlockEntity stoveEntity, float partialTicks, MatrixStack poseStack, IRenderTypeBuffer buffer, int combinedLightIn, int combinedOverlayIn) {
