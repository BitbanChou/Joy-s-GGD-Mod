...
//
//import net.joy187.joyggd.block.blockentity.BlockEntity;
...
//
//public class GBlock extends ContainerBlock implements IWaterLoggable {
...
//
//    public GBlock(boolean p_i241174_1_, int p_i241174_2_, AbstractBlock.Properties p_i241174_3_) {
//        super(p_i241174_3_);
...
//            int stoveSlot = ((BlockEntity)tileentity).getNextEmptySlot();
//            if (stoveSlot < 0 || ((BlockEntity)tileentity).isStoveBlockedAbove()) {
...
//                if (!level.isClientSide && ((BlockEntity)tileentity).addItem(player.abilities.instabuild ? heldStack.copy() : heldStack, stoveSlot)) {
...
//            TileEntity tileEntity = level.getBlockEntity(pos);
//            if (tileEntity instanceof BlockEntity) {
//                //ItemUtils.dropItems(level, pos, ((StoveBlockEntity) tileEntity).inventory);
//                InventoryHelper.dropContents(level, pos, ((BlockEntity)tileEntity).getItems());
//            }
//
...
//        return this.defaultBlockState().setValue(FACING, context.getNearestLookingDirection().getOpposite()).setValue(LIT, true);
//    }
//
