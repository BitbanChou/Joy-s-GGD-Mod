...
public class StoveBlockEntity extends TileEntity implements IClearable, ITickableTileEntity
{
    ...
    public StoveBlockEntity() {
        super(BlockEntityInit.STOVE.get());
    }

    public void tick() {
        boolean flag = this.getBlockState().getValue(StoveBlock.LIT);
...
//                    }).orElse(itemstack);
                    ...
                    else if(co>=35 && co<=40) resultStack= new ItemStack(ItemInit.BIRDWATCHER.get());
                    ...
                    else if(co>=65 && co<=70) resultStack= new ItemStack(Items.EMERALD);
                    else if(co>=75 && co<=85) resultStack= new ItemStack(Items.IRON_INGOT);
                    else if(co>85 && co<=90) resultStack= new ItemStack(ItemInit.ADVENTURER.get());
                    else if(co>=95 && co<100) resultStack= new ItemStack(ItemInit.VULTURE.get());
                    else if(co>=100 && co<105) resultStack= new ItemStack(ItemInit.DDODO.get());
                    else if(co>=105 && co<110) resultStack= new ItemStack(ItemInit.CANADIAN.get());
                    else if(co>=115 && co<120) resultStack= new ItemStack(ItemInit.MIMIC.get());
                    else if(co>=120 && co<125) resultStack= new ItemStack(ItemInit.MECHANIC.get());
                    else if(co>=125 && co<130) resultStack= new ItemStack(ItemInit.FALCON.get());
                    else if(co>=130 && co<135) resultStack= new ItemStack(ItemInit.MORTICIAN.get());
                    else if(co>=135 && co<140) resultStack= new ItemStack(ItemInit.DETECTIVE.get());
                    else if(co>=140) resultStack= new ItemStack(ItemInit.DODO.get());
...
//            }
            ...
            int l = this.getBlockState().getValue(StoveBlock.FACING).get2DDataValue();
