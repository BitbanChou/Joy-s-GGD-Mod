...
public class Stove3BlockEntity extends TileEntity implements IClearable, ITickableTileEntity
{
    ...
    public Stove3BlockEntity() {
        super(BlockEntityInit.STOVE3.get());
    }

    public void tick() {
        boolean flag = this.getBlockState().getValue(Stove3Block.LIT);
...
//                    }).orElse(itemstack);
                    ...
                    int co=ran.nextInt(130);
                    if(co<5) resultStack= new ItemStack(ItemInit.SLACK.get());
                    else if(co>=5 && co<7) resultStack= new ItemStack(Items.NETHERITE_SCRAP);
                    else if(co>=7 && co<10) resultStack= new ItemStack(Items.LEATHER_BOOTS);
                    else if(co>=10 && co<=15) resultStack= new ItemStack(ItemInit.LANTERN.get());
                    else if(co>=20 && co<=25) resultStack= new ItemStack(ItemInit.BEE.get());
                    else if(co>25 && co<=28) resultStack= new ItemStack(ItemInit.BEES.get());
                    else if(co>=28 && co<40) resultStack= new ItemStack(Items.LEATHER_CHESTPLATE);
                    else if(co>=40 && co<45) resultStack= new ItemStack(ItemInit.BOXER.get());
                    else if(co>=45 && co<=52) resultStack= new ItemStack(Items.CHAINMAIL_HELMET);
                    else if(co>=53 && co<55) resultStack= new ItemStack(ItemInit.BOXERP.get());
                    else if(co>=55 && co<=60) resultStack= new ItemStack(ItemInit.PEACE.get());
                    else if(co>60 && co<65) resultStack= new ItemStack(Items.APPLE);
                    else if(co>=65 && co<=68) resultStack= new ItemStack(Items.NETHERITE_BOOTS);
                    else if(co>69 && co<=71)  resultStack= new ItemStack(ItemInit.NV.get());
                    else if(co>71 && co<75) resultStack= new ItemStack(ItemInit.SPACESHIP.get());
                    else if(co>=75 && co<82) resultStack= new ItemStack(Items.CHAINMAIL_BOOTS);
                    else if(co>=82 && co<87) resultStack= new ItemStack(Items.GOLD_INGOT);
                    else if(co>=87 && co<90) resultStack= new ItemStack(ItemInit.MERMAIDB.get());
                    else if(co>=90 && co<97) resultStack= new ItemStack(ItemInit.OVERALL.get());
                    else if(co>=97 && co<100) resultStack= new ItemStack(ItemInit.MAID.get());
                    else if(co>=100 && co<105) resultStack= new ItemStack(ItemInit.BANANA.get());
                    else if(co>=105 && co<110) resultStack= new ItemStack(ItemInit.BOXHEAD.get());
                    else if(co>=110 && co<115) resultStack= new ItemStack(ItemInit.MERMAID.get());
                    else if(co>=115 && co<128) resultStack= new ItemStack(Items.IRON_INGOT);
                    else resultStack= new ItemStack(Items.IRON_NUGGET);
...
//            }
            ...
            int l = this.getBlockState().getValue(Stove3Block.FACING).get2DDataValue();
