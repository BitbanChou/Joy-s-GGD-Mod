...
public class SlackArmorItem extends GeoArmorItem implements IAnimatable {
    private AnimationFactory factory = new AnimationFactory(this);

    public SlackArmorItem(CustomArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
    ...
    private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
        ...
        if (livingEntity instanceof ArmorStandEntity) {
            ...
            boolean isWearingAll = armorList
                    .containsAll(Arrays.asList(ItemInit.SLACK.get()));
