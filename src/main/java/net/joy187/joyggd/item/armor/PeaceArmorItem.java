...
public class PeaceArmorItem extends GeoArmorItem implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	public PeaceArmorItem(CustomArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
...
//		}
		...
		if (livingEntity instanceof ArmorStandEntity) {
			...
			boolean isWearingAll = armorList
					.containsAll(Arrays.asList(ItemInit.PEACE.get()));
