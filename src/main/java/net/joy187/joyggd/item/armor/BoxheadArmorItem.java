...
public class BoxheadArmorItem extends GeoArmorItem implements IAnimatable {
	private AnimationFactory factory = new AnimationFactory(this);

	public BoxheadArmorItem(CustomArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
	...
	private <P extends IAnimatable> PlayState predicate(AnimationEvent<P> event) {
		...
		if (livingEntity instanceof ArmorStandEntity) {
			...
			boolean isWearingAll = armorList
					.containsAll(Arrays.asList(ItemInit.BOXHEAD.get()));
...
//		tooltip.add(Component.translatable("tooltip.drool"));
//	}
}