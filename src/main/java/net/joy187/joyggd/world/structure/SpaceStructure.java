package net.joy187.joyggd.world.structure;
...
public class SpaceStructure extends Structure<NoFeatureConfig> {

    public SpaceStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }

    @Override
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return SpaceStructure.Start::new;
    }
    ...
    private static final List<MobSpawnInfo.Spawners> STRUCTURE_MONSTERS = ImmutableList.of(
            ...
            //new MobSpawnInfo.Spawners(EntityInit.DUCK.get(), 10, 1, 2)
    );
...
//            new MobSpawnInfo.Spawners(EntityType.RABBIT, 10, 1, 4)
    ...
    public static class Start extends StructureStart<NoFeatureConfig>  {
        ...
        public void generatePieces(DynamicRegistries dynamicRegistryManager, ChunkGenerator chunkGenerator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn, NoFeatureConfig config) {
             ...
             */
            BlockPos centerPos = new BlockPos(x, Math.min(256,100+random.nextInt(80)), z);
            ...
            //Math.min(256,100+random.nextInt(80))
            ...
            JigsawManager.addPieces(
                    ...
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(Main.MOD_ID, "space/start_pool")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Space Shuttle at " +
